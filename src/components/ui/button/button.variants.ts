    ...
    variants: {
      variant: {
        primary: [
          ...
          "focus-visible:bg-primary-darkest",
          "text-white",
        ],
        secondary: [
          "bg-secondary",
          "hover:bg-secondary-dark",
          "focus-visible:bg-secondary-darkest",
          "text-white",
        ],
        tertiary: [
          "bg-tertiary",
          "hover:bg-tertiary-dark",
          "focus-visible:bg-tertiary-darkest",
          "text-white",
        ],
        neutral: [
          "bg-neutral-lightest",
        ...
        ghost: [
          ...
          "focus-visible:bg-neutral-light",
          "text-neutral",
        ],
        danger: [
          "bg-danger",
          "hover:bg-danger-dark",
          "focus-visible:bg-danger-darkest",
          "text-white",
        ],
      },
      size: {
